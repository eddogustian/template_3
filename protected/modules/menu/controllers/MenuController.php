...
class MenuController extends RController
{
    ...
    {
		// Check User Access
		if(!AppComponent::get_user_access('menu', 'status'))
	...
	{
		$dataProvider=new CActiveDataProvider('MenuMdl');
	...
	{
		$model=new MenuMdl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MenuMdl']))
			$model->attributes=$_GET['MenuMdl'];
	 ...
	 * @return MenuMdl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=MenuMdl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param MenuMdl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='menu-mdl-form')
		{
