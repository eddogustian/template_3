...
<form class="login-form" action="<?php echo Yii::app()->baseUrl; ?>/index.php/user/login" method="post" autocomplete="off">
	...
	<div class="form-group">
		...
		<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="UserLogin[username]" id="UserLogin_username" /> 
	</div>
	<div class="form-group">
